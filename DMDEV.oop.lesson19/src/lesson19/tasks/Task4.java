...
/*
4. Сложить два многочлені заданной степени, если коеф-ті многочлена хранятся в обїекте HashMap
в виде:
Ключ: номер степени
Значение: значениие множителя
...
public class Task4 {
    ...
    private static Map<Integer, Integer> sum(Map<Integer, Integer> polynomial1, Map<Integer, Integer> polynomial2){
